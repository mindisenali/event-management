      ...
      >
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-10 rounded-[2.5rem] shadow-[0_20px_80px_rgba(0,0,0,0.5)] flex flex-col gap-10">
          <div className="text-center">
            <h2 className="text-4xl font-black font-syne uppercase tracking-tight">Welcome <span className="text-accent">Back</span></h2>
            <p className="text-white/40 mt-2 font-medium">Continue your journey with Eventify</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6" autoComplete="off">
            ...
            <div className="flex justify-end -mt-4">
              <Link to="/forgot-password" size="sm" className="text-[10px] font-black uppercase tracking-widest text-white/30 hover:text-accent transition-colors">
                Forgot Password?
              </Link>
            </div>
          ...
          <p className="text-center text-xs font-bold text-white/40 uppercase tracking-widest">
            Don't have an account? <Link to="/register" className="text-accent hover:text-white transition-colors ml-1">Create one</Link>
          </p>
        </div>
      </motion.div>
    </div>
